...
`82295d6`: the calibration, the ladder, `pending` counting a bake between its chunks, a fallback adapter starting low, the report, the first frame fenced, and every pipeline compiled off the main thread.
